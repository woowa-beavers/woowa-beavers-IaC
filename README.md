...
| 계정 | 역할 | Terraform |
|:---:|:---|:---:|
| Root | SCP, Organizations, IAM Identity Center | 보류 |
| sec | Wazuh, TheHive, MISP, GuardDuty, SecurityHub, CloudTrail Lake | ✅ |
| ops | GitHub Actions OIDC, CI/CD, Terraform 실행 주체 | 보류 |
| dev / staging / prod | 쇼핑몰 인프라 | ✅ (dev) |
| billing | 비용 알림 | - |
