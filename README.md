...
| 계정 | 역할 | Terraform |
|:---:|:---|:---:|
| root | SCP, Organizations, IAM Identity Center | 진행 중 |
| sec | Wazuh, TheHive, MISP, GuardDuty, SecurityHub, CloudTrail, Config | 진행 중 |
| ops | GitHub Actions OIDC, CI/CD, Terraform 실행 주체 | 진행 중 |
| dev | 쇼핑몰 인프라 | 진행 중 |
| billing | 비용 알림 | - |
...
│   │   └── prod/                   # 프로덕션 환경 (미작성)
│   │       └── main.tf
│   ├── sec/                        # sec 계정 - 보안 서버 (독립 구조)
│   │   ├── modules/
│   │   │   ├── compute/            # EC2 (TheHive NAT 인스턴스·서버)
│   │   │   ├── networking/         # MISP VPC/서브넷 조회, NAT Gateway
│   │   │   ├── security/           # GuardDuty, SecurityHub, Config, CloudTrail, KMS (미작성)
...
│   │   └── main.tf
│   ├── root/                       # root 계정 - SCP, Organizations (미작성)
│   │   └── main.tf
